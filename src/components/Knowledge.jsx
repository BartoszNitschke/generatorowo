...
export const Knowledge = () => {
  ...
  const scaleProgres = useTransform(scrollYProgress, [0, 1], [0.9, 1]);
              ...
              {powerGenerators && (
                ...
                >
                  ...
                  <p className="mt-3 pb-3 text-[18px] text-gray-300 font-semibold">
                    ...
                    podłączenie uziemienia grozi porażeniem prądem elektrycznym,
                    uszkodzeniem odbiorników do niego podłączonych lub
                    generatora.
                  </p>
                </motion.div>
              )}
              ...
              {inductionGenerators && (
                ...
                >
                  <p className="mt-5 text-[18px]">
                    ...
                    posiadające zaawansowanej elektroniki z pominięciem starego
                    tupu urządzeń z zasilaczami transformatorowymi.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
              ...
              {powerCounting && (
                ...
                >
                  <p className="mt-5 text-[18px]">
                    ...
                    kondensatorem) może mieć chwilowo nawet do 3,5 razy większy
                    pobór prądu. Trzeba pamiętać o tym że pobór prądu przez
                    urządzenie może być zmienny w zależności od obciążenia
                    urządzenia, ale nie większy niż 3,5 razy od tego co jest
                    podane na tabliczce znamionowej urządzenia. W szczególnych
                    przypadkach i przy maksymalnym obciążeniu urządzenia prąd
                    szczytowy może być nawet do sześciu razy większy niż
                    deklarowany przez producenta urządzenia. Nie dotyczy to
                    urządzeń: czajniki elektryczne, grzejniki z grzałką ale bez
                    dmuchawy, w tych urządzeniach pobór prądu jest zawsze stały
                    i nie zmienny. (urządzenia oporowe). W generatorach
                    trójfazowych gniazdo 230V wyprowadzone jest z jednej z
                    trzech faz i jest na nim jedna trzecia mocy całkowitej
                    generatora(jeśli generator trój fazowy ma 6kW) to na
                    gnieździe 230V będzie 2kW.
                  </p>
              ...
              {whichGenerator && (
                ...
                >
                  <p className="mt-5 text-[18px]">
                    ...
                    wszystkich wyżej wymienionych urządzeń ale przede wszystkim
                    do urządzeń elektronicznych nowszej generacji a w
                    szczególności sterowniki pieców, komputery, zasilacze
                    awaryjne UPS, przyrządy medyczne wspomagające funkcje
                    życiowe. Wszystkie generatory z silnikiem spalinowym
                    chłodzonym powietrzem nie są przystosowane do pracy ciągłej.
                    Generator po wypaleniu całego zbiornika paliwa powinien
                    zostać wyłączony na przynajmniej pół godziny w celu
                    ostygnięcia. Po ostygnięciu generatora możemy uzupełnić
                    paliwo w zbiorniku, sprawdzić poziom oleju, wyczyścić
                    generator i ponownie go uruchomić. Utrzymanie generatora w
                    czystości, regularne wymiany oleju oraz utrzymanie.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
              ...
              {generatorTests && (
                ...
                >
                  ...
                  <p className="mt-3 text-[18px]">
                    ...
                    instrukcją użytkownika. Przy testach prądnicy użyto elementu
                    oporowego o wartości 60% mocy prądnicy generatora w trakcie
                    długiego testu i podczas chwilowego testu obciążenie 100%
                    mocy prądnicy.
                  </p>
                </motion.div>
              )}
