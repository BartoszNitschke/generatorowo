  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-center gap-x-10">
        <div className="max-w-[320px] bg-gradient-to-b from-gray-700 via-gray-800 to-gray-700 flex flex-col justify-center items-center p-4 rounded-3xl shadow-lg shadow-gray-600 text-center hover:scale-105 cursor-pointer transition-transform duration-300 text-gray-300">
